...
const suggestionLists = {
  ...
  assignments: [
    ...
    "Homework Fix",
    "Pay Karke Submit",
    "Assignment Jaldi Mile",
    "Copy-Paste Assignment",
  ],
  scolarship: [
    "Scholarship Mil Raha Hai",
    "Free Paisa for Students",
    "Apply Karo Aur Bacha Lo",
  ...
  projects: [
    "Ready-Made Project",
    "Project Banwa Lo",
    "Pay Karke Project Le Lo",
    "Shortcut Project",
    "Project Jaldi Mile",
  ],
  jobs: [
    "Walk-In Interview",
    "Job Milane Wale Agency",
    "Pay Karke Interview Crack Karo",
    "Fast Job Hustle",
    "Job Jaldi Mile",
  ],
};
