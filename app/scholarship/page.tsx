...
import faqs from "@/app/scholarship/scholarships";
    ...
    <section className="mx-auto w-full max-w-6xl py-20 sm:px-6 sm:py-32 lg:px-8 lg:py-40">
      <div className="mx-auto flex w-full max-w-4xl flex-col items-center gap-6 lg:flex-row lg:items-start lg:gap-12">
        <h2 className="px-2 text-3xl leading-7">
          <span className="inline-block lg:hidden">$chol@rship&apos;s</span>
          <span className="from-foreground-800 to-foreground-500 dark:to-foreground-200 hidden bg-linear-to-br bg-clip-text pt-4 text-5xl font-semibold tracking-tight text-transparent lg:inline-block">
            Scholarship
            <br />
            No Bullshit
            <br />
